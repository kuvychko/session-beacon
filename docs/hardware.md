...
Done, unlike `env_monitoring`, which never got past the breadboard. Three printed parts stacking to 19 mm on a 40 x 60 mm footprint, held by four M2 x 16 socket-head screws, plus an optional stand that tilts the whole thing back 25 degrees. Source files and the full bill of materials are in [enclosure.md](enclosure.md).
